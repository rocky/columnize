...
class TestRowsAndCols < Test::Unit::TestCase
  ...
  def test_compute_rows_cols_and_width
    # Try at least one test where we give the module name explicitely.
    assert_equal([1, 3, [8,8,8]], Columnize::compute_rows_cols_and_width([1, 2, 3], OPTS))
  ...
  #   assert_equal("0,  6, 12, 18, 24, 30, 36, 42, 48, 54\n" +
  ...
  #    assert_equal("one         two         three        for          five         six        \n" +
  #                 "seven       eight       nine         ten          eleven       twelve     \n" +
  #                 "thirteen    fourteen    fifteen      sixteen      seventeen    eightteen  \n" +
  #                 "nineteen    twenty      twentyone    twentytwo    twentythree  twentyfour \n" +
  #                 "twentyfive  twentysix   twentyseven\n", columnize(data, 80, '  ', false))

  #   assert_equal("one    five   nine    thirteen  seventeen  twentyone    twentyfive \n" +

...
class TestComputeRowsAndColwidths < Test::Unit::TestCase
  ...
  def test_colwidths
    ...
    # horizontal
    rows, colwidths = min_rows_and_colwidths(data, HOPTS)
    ...
    # vertical
    rows, colwidths = min_rows_and_colwidths(data, VOPTS)
  ...
  def test_horizontal_vs_vertical
    ...
    # horizontal
    rows, colwidths = min_rows_and_colwidths(data, HOPTS.merge(:displaywidth => 39))
    ...
    # vertical
    rows, colwidths = min_rows_and_colwidths(data, VOPTS.merge(:displaywidth => 39))
